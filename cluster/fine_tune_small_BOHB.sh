...
#SBATCH --cpus-per-task=28  ### cpus and gpus per node 
#SBATCH --gres=gpu:4
...
cd asr-finetune
python -u main_ray_for_HF.py -c configs/train_whisper_small_BOHB_jan.config

#python -u main_ray_for_HF.py -c configs/train_whisper_small_PBT.config
